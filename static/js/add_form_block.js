...
function add_question(){
    ...
    $(".form-container").append(
        ...
        `<input placeholder="Renseignez l'intitulé de la question" type="text" class="form-control" id="question" name="question">`+
        '</div>');
    compteur++;
}
...
function add_question_multiple(){
    ...
    $(".form-container").append(
        ...
        `<input placeholder="Renseignez la réponse" type="text" class="form-control" id="reponse" name="reponse">`+
        `<input placeholder="Renseignez la réponse" type="text" class="form-control" id="reponse" name="reponse">`+
        `<input placeholder="Renseignez la réponse" type="text" class="form-control" id="reponse" name="reponse">`+
        '</div>'+
        '</div>');
